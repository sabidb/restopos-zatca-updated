...
const APP_VERSION="v29.1.5";
const APP_VERSION_FULL="RestoPOS v29.1.5 · ZATCA Phase 2";
...
function buildPresetHTML(order,license,zatcaInvoice,fmt,qrImgSrc,opts){
  ...
  const tokenBox=boxed(`<div style="display:flex;justify-content:space-between;align-items:center;gap:8px"><span style="font-weight:${wToken};font-size:${tokenFont}px">Token No: ${_escHTML(order.token||order.kot||"—")}</span>${_arSpan(orderTypeAr||order.type||"","font-size:"+tokenFont+"px")}</div>`);
  // ── VOUCHER ──
