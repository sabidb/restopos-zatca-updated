...
const APP_VERSION_FULL="RestoPOS v28 · ZATCA Phase 2";
...
function SilentPrintSetup(){
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",gap:14}}>
      <div style={{background:C.zatcaLight,border:`1px solid ${C.zatca}44`,borderRadius:10,padding:"12px 16px",fontSize:13,color:C.zatca,fontWeight:600}}>
        🔇 Set this up <strong>once per computer</strong> and every invoice, draft and report prints instantly — no “Allow / Untrusted website” pop-up, ever.
      </div>
